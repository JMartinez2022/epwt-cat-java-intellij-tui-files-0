package cat.ilg.m3.uf3.ejercicio0;

import java.util.Scanner;
import static cat.ilg.m3.uf3.ejercicio0.Utils.stringToInt;
...
public class App {
    ...
    static public Student[] initTui() {
        ...
        String numberOfStudentsStr= sc.nextLine();
        ...
        if(numberOfStudents > 0) {
            ...
            for(int i = 0; i < numberOfStudents; i++){
                ...
                newStudent.amountOfEnrolledSubjects = sc.nextInt();
